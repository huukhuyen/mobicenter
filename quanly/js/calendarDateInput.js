...
var CellWidth = 18;
var CellHeight = 16;
var ImageURL = BASE_URL+'admincp/images/calendar/calendarIcon.png';
var NextURL = BASE_URL+'admincp/images/calendar/calendarNext.gif';
var PrevURL = BASE_URL+'admincp/images/calendar/calendarPrev.gif';
...
function DateInput(DateName, Required, DateFormat, DefaultDate) {
   if (arguments.length == 0) document.writeln('<span style="color:red;font-size:' + FontSize + 'px;font-family:' + FontFamily + ';">ERROR: Missing required parameter in call to \'DateInput\': [name of hidden date field].</span>');
      ...
      with (document) {
         ...
         writeln('<table cellpadding="0" cellspacing="2"><tr>' + String.fromCharCode(13));
         ...
         writeln('</tr>' + String.fromCharCode(13) + '</table>' + String.fromCharCode(13) + '<span id="' + DateName + '_DayTable_ID">' + eval(DateName + '_Object.buildCalendar()') + '</span>' + String.fromCharCode(13) + '</span>' + String.fromCharCode(13) + '</td>');
