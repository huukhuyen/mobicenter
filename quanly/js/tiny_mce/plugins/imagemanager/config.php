<?php
        ...
        $mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,zip,doc,ppt,xls,rar,docx,pptx,xlsx,swf";
        ...
        $mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,zip,doc,ppt,xls,rar,docx,pptx,xlsx,swf";
