...
<form method="post"
    action="index.php?module=PictureCategories&act=<?php
...
<table class="adminform" style="width: 700px;">
	...
	<tr>
        ...
        <td><input class="input" type="text" name="Status" size="40"maxlength="255"value="<?php echo ($fields != null ? $fields ['Status'] : '1');?>" /></td>
    </tr>
	
	<tr>
        <td><label for="title">Link SEO</label></td>
        <td><input class="input" type="text" name="Slug" size="40"maxlength="255"value="<?php echo ($fields != null ? $fields ['Slug'] : '');?>" /> <i>Để trống nếu muốn hệ thống tự động tạo</i></td>
    </tr>
    ...
    <tr>
        ...
        <td><input class="button" type="submit"
            ...
            if ($fields != null) :
                ?>
            <input type="hidden" name="PictureCategoryID"
            value="<?php
                echo $fields ['PictureCategoryID'];
                ?>" />            
            <?php endif;
            ?>
            <?php
